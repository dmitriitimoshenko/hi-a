...
type Application struct {
	...
	EmploymentType           enums.EmploymentType    `gorm:"column:employment_type;size:64;not null"`
	WorkMode                 enums.WorkMode          `gorm:"column:work_mode;size:64;not null"`
	Status                   enums.ApplicationStatus `gorm:"column:status;size:64;not null"`
	...
	RowID                    int64                   `gorm:"column:row_id;uniqueIndex;not null"`
	AppliedEmailReceived     *time.Time              `gorm:"column:applied_email_received"`
	AppliedEmailID           *int64                  `gorm:"column:applied_email_id"`
	DeniedEmailReceived      *time.Time              `gorm:"column:denied_email_received"`
	DeniedEmailID            *int64                  `gorm:"column:denied_email_id"`
	MeetingInvEmailReceived  *time.Time              `gorm:"column:meeting_inv_email_received"`
	MeetingInvEmailID        *int64                  `gorm:"column:meeting_inv_email_id"`
	MeetingCrtEmailReceived  *time.Time              `gorm:"column:meeting_crt_email_received"`
	MeetingCrtEmailID        *int64                  `gorm:"column:meeting_crt_email_id"`
	MeetingUpdEmailReceived  *time.Time              `gorm:"column:meeting_upd_email_received"`
	MeetingUpdEmailID        *int64                  `gorm:"column:meeting_upd_email_id"`
	MeetingCnclEmailReceived *time.Time              `gorm:"column:meeting_cncl_email_received"`
	MeetingCnclEmailID       *int64                  `gorm:"column:meeting_cncl_email_id"`
	SalaryAppliedID          *int64                  `gorm:"column:salary_applied_id;index"`
	SalaryProposedID         *int64                  `gorm:"column:salary_proposed_id;index"`

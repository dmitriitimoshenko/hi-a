...
import (
	...
	"github.com/dmitriitimoshenko/hi-a/telegram-bot/internal/app/bus/handlers/messages"
...
func (h *NotificationSyncHandler) Handle(ctx context.Context, message busclient.Message) error {
